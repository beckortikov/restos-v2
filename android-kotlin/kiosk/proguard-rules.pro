...
# Приложение киоска — DTO в com.restos.kiosk.**
-keep,includedescriptorclasses class com.restos.kiosk.**$$serializer { *; }
-keepclassmembers class com.restos.kiosk.** {
    *** Companion;
}
-keepclasseswithmembers class com.restos.kiosk.** {
