...
--
-- 075_sync_backfilled_at — маркер «история этого филиала уже отправлена
-- на central» (ADR-003 «Central видит всё», Ф6).
-- (Перенумерована 066→072→074→075 за три мержа main подряд — main каждый
-- раз независимо занимал те же номера своими миграциями.)
--
