...
--
-- 076_network_invites — код приглашения для подключения филиала к сети
-- (ADR-003, продолжение). Перенумерована 073→075→076 за два мержа main
-- подряд. Central генерирует одноразовый короткий код
