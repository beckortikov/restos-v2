    ...
    <>
      <div className="bg-amber-50 rounded-lg border border-amber-200 p-3 space-y-2">
        ...
        <p className="text-[11px] text-amber-700 leading-snug">
          Удалит все операции: заказы, смены, фин. операции, весь склад (движения, накладные, инвентаризации, списания, возвраты, заготовки, хозрасходы), ЗП-историю (авансы, удержания, дни), брони, журнал, плановые платежи. Обнулит деньги на счетах, остатки и долги поставщикам. Сохранит: номенклатуру, поставщиков, меню, тех.карты, столы, сотрудников, счета, клиентов.
        </p>
        <button
