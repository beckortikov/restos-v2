...
import {
  ...
  SlidersHorizontal, CookingPot, Undo2, ArrowLeftRight, type LucideIcon,
} from 'lucide-react'
...
export const MOVEMENT_TYPE_META: Record<StockMovementType, { label: string; color: string; bg: string; Icon: LucideIcon }> = {
  ...
  transfer: { label: 'Перемещение',     color: 'text-cyan-600',         bg: 'bg-cyan-100 dark:bg-cyan-500/15',      Icon: ArrowLeftRight },
}
