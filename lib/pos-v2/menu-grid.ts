...
// CSS для контейнера сетки. В матричном режиме высота рядов подгоняется под
// высоту видимой области (areaH, px), чтобы на экран влезло ровно rows рядов,
// а карточки были квадратнее. Лишние блюда уходят под скролл.
